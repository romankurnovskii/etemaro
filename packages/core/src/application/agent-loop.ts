...
export const SCREENER_TOOLS = new Set([
  ...
  "get_token_info", "search_pools", "get_pool_memory",
  "get_wallet_balance", "get_my_positions",
]);

export const GENERAL_INTENT_ONLY_TOOLS = new Set([
  "self_update", "update_config",
  "add_to_blacklist", "remove_from_blacklist",
  "block_deployer", "unblock_deployer",
  "add_pool_note", "set_position_note",
...
export interface AgentLoopCallbacks {
  ...
  onToolFinish?: (info: { name: string; args: Record<string, unknown>; result: Record<string, unknown>; success: boolean; step: number }) => void | Promise<void>;
}
