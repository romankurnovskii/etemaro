/**
 * @file defaultStrategies.ts
 * @description Bundled default LP strategy profiles shipped with etemaro.
 *
 * These are the fallback open-source strategies used when no shared library
